...
public class AndronShaderProgram {
	...
	public static int h_a_Color;
	public static final int SIZE_a_Color_floats=3;
	public static final int OFFSET_a_Color_floats=SIZE_a_Position_floats;
	...
	public static final int STRIDE_floats=OFFSET_a_Color_floats+SIZE_a_Color_floats;
	public static final int STRIDE_bytes=STRIDE_floats*Framework3D.BYTES_PER_FLOAT;
	
	public static boolean initialized=false;
	public static void initialize(){
		initialized=true;
		final String vertexShader = RawResourceReader.readTextFileFromRawResource(App.getContext(), R.raw.shader_andron_vs);   		
 		final String fragmentShader = RawResourceReader.readTextFileFromRawResource(App.getContext(), R.raw.shader_andron_fs);
        ...
        h_a_Color = GLES20.glGetAttribLocation(shaderhandle, "a_Color");
...
public static void setOpacity(float opacity) {
	GLES20.glUniform1f(h_u_opacity,opacity);//dissolvance
}
	...
	/*public static void setTexture(int textureid){
 	...
 	public static void setVertices(int GPUvertexdatahandle){
		...
		GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, GPUvertexdatahandle);
		GLES20.glEnableVertexAttribArray(h_a_Color);
		GLES20.glVertexAttribPointer(h_a_Color, SIZE_a_Color_floats, GLES20.GL_FLOAT, false, STRIDE_bytes, OFFSET_a_Color_floats * Framework3D.BYTES_PER_FLOAT);
