...
public static class Record_activity_table {

    private Indicium database;
    public Record_activity_table(Indicium database,DataInputStream dis){
        this.database=database;
        try{
...
image=new Indicium_Image(dis,dis.readInt());
datalen=dis.readUnsignedShort();
